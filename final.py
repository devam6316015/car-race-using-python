...
pygame.mixer.music.load("Gaddi.mp3")
...
def intro():
    ...
    while intro:
        ...
        message_display("Need for Speed:Haryana", 60, display_width / 2, display_height / 2)
        ...
        if menu1_x < mouse[0] < menu1_x + menu_width and menu1_y < mouse[1] < menu1_y + menu_height:
            pygame.draw.rect(gameDisplay, dark_green, (200, 400, 100, 50))
            if click[0] == 1:
                intro = False
        if menu2_x < mouse[0] < menu2_x + menu_width and menu2_y < mouse[1] < menu2_y + menu_height:
            pygame.draw.rect(gameDisplay, dark_red, (500, 400, 100, 50))
            if click[0] == 1:
                pygame.quit()
                quit()
...
def crash(x, y):
    ...
    message_display("You loss.! try again", 50, display_width / 2, display_height / 2)
    pygame.display.update()
    time.sleep(2)
    gameloop()
